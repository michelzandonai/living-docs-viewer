import { a3 as S, a6 as F, aF as j, g as Z, s as q, a as H, b as J, p as K, o as Q, _ as p, l as z, c as X, C as Y, G as ee, M as te, d as ae, x as re, D as ne } from "./mermaid.core-B6l_a5sU.js";
import { p as ie } from "./chunk-4BX2VUAB-DxwJQwHb.js";
import { p as se } from "./mermaid-parser.core-Dlu6x29Q.js";
import "./index-lqS_9XS_.js";
import { d as I } from "./arc-BG1lZxxP.js";
...
function ue() {
  var e = ce, a = oe, f = null, x = S(0), s = S(F), o = S(0);
  function l(t) {
    var n, c = (t = j(t)).length, g, y, m = 0, u = new Array(c), i = new Array(c), v = +x.apply(this, arguments), w = Math.min(F, Math.max(-F, s.apply(this, arguments) - v)), h, C = Math.min(Math.abs(w) / c, o.apply(this, arguments)), $ = C * (w < 0 ? -1 : 1), d;
    for (n = 0; n < c; ++n)
