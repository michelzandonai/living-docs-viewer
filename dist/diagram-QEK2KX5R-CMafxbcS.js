import { s as k, g as I, p as R, o as E, a as _, b as D, _ as l, G as F, x as G, C as y, D as P, E as C, l as z, I as V } from "./mermaid.core-r1-Nq2X6.js";
import { p as W } from "./chunk-4BX2VUAB-H5ht9u7v.js";
import { p as B } from "./mermaid-parser.core-DFmzdQ-x.js";
var x = {
  showLegend: !0,
  ticks: 5,
  max: null,
  ...
  const s = r.db, o = s.getAxes(), i = s.getCurves(), n = s.getOptions(), c = s.getConfig(), d = s.getDiagramTitle(), p = F(t), u = et(p, c), g = n.max ?? Math.max(...i.map((f) => Math.max(...f.entries))), m = n.min, v = Math.min(c.width, c.height) / 2;
