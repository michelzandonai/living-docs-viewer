import { _ as dt, G as Ze, U as ke, l as Se, b as qe, a as Qe, o as Je, p as Ke, g as je, s as _e, x as tr, C as er, D as rr, E as ir, c as Ee, aj as me, aH as pe, h as ar, v as nr, aI as or, aJ as sr } from "./mermaid.core-CoRdmO9j.js";
import { p as hr } from "./chunk-4BX2VUAB-BesGezha.js";
import { p as lr } from "./mermaid-parser.core-BO3RZIfK.js";
import { c as Fe } from "./cytoscape.esm-CjI2IsL8.js";
import { e as fr, s as cr } from "./index-BJzl1930.js";
            ...
            u.svd = function(h) {
              ...
              for (var $ = n - 1, _ = Math.pow(2, -52), ht = Math.pow(2, -966); n > 0; ) {
                ...
                switch (q++, It) {
                  ...
                  case 3:
                    {
                      var Yt = Math.max(Math.max(Math.max(Math.max(Math.abs(this.s[n - 1]), Math.abs(this.s[n - 2])), Math.abs(r[n - 2])), Math.abs(this.s[q])), Math.abs(r[q])), Vt = this.s[n - 1] / Yt, b = this.s[n - 2] / Yt, U = r[n - 2] / Yt, B = this.s[q] / Yt, J = r[q] / Yt, Z = ((b + Vt) * (b - Vt) + U * U) / 2, at = Vt * U * (Vt * U), ct = 0;
                ...
                s.handleConstraints = function(c) {
                  ...
                  if (i.ENFORCE_CONSTRAINTS) {
                    if (l.fixedNodeConstraint && l.fixedNodeConstraint.length > 0) {
                      var Et = { x: 0, y: 0 };
                      l.fixedNodeConstraint.forEach(function(b, U) {
                        var B = { x: v[d.get(b.nodeId)], y: L[d.get(b.nodeId)] }, J = b.position, Z = X(J, B);
                        Et.x += Z.x, Et.y += Z.y;
                    ...
                    if (l.alignmentConstraint) {
                      if (l.alignmentConstraint.vertical)
                        for (var Dt = l.alignmentConstraint.vertical, Rt = function(U) {
                          ...
                          J.size > 0 ? Z = v[d.get(J.values().next().value)] : Z = Q(B).x, B.forEach(function(at) {
                      ...
                      if (l.alignmentConstraint.horizontal)
                        for (var Ut = l.alignmentConstraint.horizontal, Pt = function(U) {
                          ...
                          J.size > 0 ? Z = L[d.get(J.values().next().value)] : Z = Q(B).y, B.forEach(function(at) {
                    ...
                    l.relativePlacementConstraint && (function() {
                      var b = /* @__PURE__ */ new Map(), U = /* @__PURE__ */ new Map(), B = /* @__PURE__ */ new Map(), J = /* @__PURE__ */ new Map(), Z = /* @__PURE__ */ new Map(), at = /* @__PURE__ */ new Map(), ct = /* @__PURE__ */ new Set(), nt = /* @__PURE__ */ new Set();
                  ...
                  var n = function(x) {
                    ...
                    for (var et = k.length, z = 0; z < et; z++) {
                      ...
                      if (w.outerWidth() != null && w.outerHeight() != null)
                        if (Y.randomize)
                          if (!w.isParent())
                            $ = x.add(new g(V.graphManager, new t(Q[X.get(w.id())] - _.w / 2, O[X.get(w.id())] - _.h / 2), new o(parseFloat(_.w), parseFloat(_.h))));
                          else {
              ...
              ((a, r, e) => {
                var f = e(548), i = e(140).layoutBase.Matrix, g = e(140).layoutBase.SVD, t = function(s) {
                  var c = s.cy, l = s.eles, T = l.nodes(), d = l.nodes(":parent"), v = /* @__PURE__ */ new Map(), L = /* @__PURE__ */ new Map(), S = /* @__PURE__ */ new Map(), C = [], G = [], K = [], X = [], Q = [], O = [], rt = [], n = [], m = void 0, p = 1e8, E = 1e-9, y = s.piTol, R = s.samplingType, M = s.nodeSeparation, F = void 0, W = function() {
                    ...
                    for (var U = g.svd(rt), B = U.S, J = U.U, Z = U.V, at = B[0] * B[0] * B[0], ct = [], nt = 0; nt < F; nt++) {
                      ct[nt] = [];
                      for (var tt = 0; tt < F; tt++)
                  ...
                  var Nt = function(U) {
                    ...
                    v.get(U).forEach(function(Z) {
                      c.getElementById(Z).isParent() ? J = S.get(Z) : J = Z, C[B].push(J), C[L.get(J)].push(U);
                    });
                  }, vt = !0, it = !1, gt = void 0;
                  try {
...
function $e(I, D, A, P, N, { spatialMaps: u, groupAlignments: h }) {
  return new Promise((a) => {
    const r = cr("body").append("div").attr("id", "cy").attr("style", "display:none"), e = Fe({
