import { g as le } from "./chunk-55IACEB6-DibL7BWR.js";
import { s as he } from "./chunk-QN33PNHL-BMwTy37p.js";
import { _ as l, l as C, n as de, r as ge, D as G, c as X, h as F, aG as ue, V as pe, W as fe, X as ye } from "./mermaid.core-Z6JQ7gGy.js";
const E = [];
for (let t = 0; t < 256; ++t)
...
var q = (function() {
  var t = /* @__PURE__ */ l(function(v, s, i, a) {
    ...
    parse: /* @__PURE__ */ l(function(s) {
      var i = this, a = [0], o = [], g = [null], r = [], U = this.table, d = "", V = 0, Z = 0, re = 2, ee = 1, ae = r.slice.call(arguments, 1), f = Object.create(this.lexer), T = { yy: {} };
      ...
      for (var S, O, k, W, I = {}, M, L, ie, B; ; ) {
        if (O = a[a.length - 1], this.defaultActions[O] ? k = this.defaultActions[O] : ((S === null || typeof S > "u") && (S = te()), k = U[O] && U[O][S]), typeof k > "u" || !k.length || !k[0]) {
          ...
          B = [];
          for (M in U[O])
            this.terminals_[M] && M > re && B.push("'" + this.terminals_[M] + "'");
          f.showPosition ? z = "Parse error on line " + (V + 1) + `:
` + f.showPosition() + `
Expecting ` + B.join(", ") + ", got '" + (this.terminals_[S] || S) + "'" : z = "Parse error on line " + (V + 1) + ": Unexpected " + (S == ee ? "end of input" : "'" + (this.terminals_[S] || S) + "'"), this.parseError(z, {
            text: f.match,
        ...
        switch (k[0]) {
          case 1:
            a.push(S), g.push(f.yytext), r.push(f.yylloc), a.push(k[1]), S = null, Z = f.yyleng, d = f.yytext, V = f.yylineno, $ = f.yylloc;
            break;
          case 2:
