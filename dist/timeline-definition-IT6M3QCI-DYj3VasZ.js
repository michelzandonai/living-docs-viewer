import { _ as s, c as xt, l as E, U as kt, V as vt, W as _t, X as bt, A as wt, Y as St, x as Et } from "./mermaid.core-CuPiA7UA.js";
import { s as U } from "./index-B3X8tJpT.js";
import { d as nt } from "./arc-CJZTP0Td.js";
var X = (function() {
  var n = /* @__PURE__ */ s(function(f, r, a, h) {
    ...
    parse: /* @__PURE__ */ s(function(r) {
      ...
      s(P, "lex");
      for (var w, H, I, K, V = {}, j, A, et, G; ; ) {
        if (H = h[h.length - 1], this.defaultActions[H] ? I = this.defaultActions[H] : ((w === null || typeof w > "u") && (w = P()), I = S[H] && S[H][w]), typeof I > "u" || !I.length || !I[0]) {
          var Q = "";
          G = [];
          for (j in S[H])
...
Expecting ` + G.join(", ") + ", got '" + (this.terminals_[w] || w) + "'" : Q = "Parse error on line " + (M + 1) + ": Unexpected " + (w == J ? "end of input" : "'" + (this.terminals_[w] || w) + "'"), this.parseError(Q, {
        ...
        switch (I[0]) {
          case 1:
            ...
            break;
          case 2:
            if (A = this.productions_[I[1]][1], V.$ = y[y.length - A], V._$ = {
              ...
              return K;
            A && (h = h.slice(0, -1 * A * 2), y = y.slice(0, -1 * A), o = o.slice(0, -1 * A)), h.push(this.productions_[I[1]][0]), y.push(V.$), o.push(V._$), et = S[h[h.length - 2]][h[h.length - 1]], h.push(et);
            break;
          case 3:
            return !0;
        }
...
var W = "", lt = 0, Y = [], q = [], z = [], ot = /* @__PURE__ */ s(() => St, "getCommonDb"), ct = /* @__PURE__ */ s(function() {
  Y.length = 0, q.length = 0, W = "", z.length = 0, Et();
...
}, "drawSection"), rt = -1, At = /* @__PURE__ */ s(function(n, t, e) {
...
function tt(n, t) {
  n.each(function() {
    var e = U(this), l = e.text().split(/(\s+|<br>)/).reverse(), i, d = [], c = 1.1, g = e.attr("y"), m = parseFloat(e.attr("dy")), p = e.text(null).append("tspan").attr("x", 0).attr("y", g).attr("dy", m + "em");
...
var Ft = /* @__PURE__ */ s(function(n, t, e, l) {
  ...
  for (const [L, b] of x.entries()) {
    ...
    for (const w of b.events) {
      ...
      P += F.getVirtualNodeHeight(p, H, i);
    }
  ...
  E.debug("maxSectionHeight before draw", r), E.debug("maxTaskHeight before draw", a), f && f.length > 0 ? f.forEach((L) => {
    ...
    E.debug("sectionNode", $);
    const R = p.append("g"), P = F.drawNode(R, $, S, i);
    E.debug("sectionNode output", P), R.attr("transform", `translate(${y}, ${u})`), o += r + 50, b.length > 0 && st(
      p,
      b,
      S,
      y,
