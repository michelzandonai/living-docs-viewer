import { s as gi, g as xi, p as Xt, o as di, a as fi, b as pi, _ as a, l as Nt, G as mi, d as yi, x as bi, E as St, h as Ai, C as Yt, D as wi, I as Ci, aE as Si, Q as Wt } from "./mermaid.core-r1-Nq2X6.js";
import "./index-SaPJfUvr.js";
import { i as _i } from "./init-DjUOC4st.js";
import { o as ki } from "./ordinal-DfAQgscy.js";
import { l as zt } from "./linear-C3JKPENZ.js";
function Ri(e, t, i) {
...
}, a(nt, "XYChartBuilder"), nt), rt = 0, qt, ot = Tt(), ht = Rt(), A = Dt(), Ct = ht.plotColorPalette.split(",").map((e) => e.trim()), gt = !1, kt = !1;
function Rt() {
  const e = Ci(), t = St();
...
function ni() {
  ...
  return A.title = Xt(), Vi.build(ot, A, ht, qt);
}
