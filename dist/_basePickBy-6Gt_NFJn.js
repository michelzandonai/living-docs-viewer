import { e as x, c as b, g as m, k as P, h as p, j as w, l as N, m as c, n as I, t as A, o as M } from "./_baseUniq-DHjU5J3f.js";
import { aK as g, aq as E, aL as F, aM as _, aN as $, aO as l, aP as B, aQ as S, aR as T, aS as y } from "./mermaid.core-CoRdmO9j.js";
var L = /\s/;
function R(n) {
...
var q = /^\s+/;
function G(n) {
  return n && n.slice(0, R(n) + 1).replace(q, "");
}
var o = NaN, H = /^[-+]0x[0-9a-f]+$/i, K = /^0b[01]+$/i, z = /^0o[0-7]+$/i, C = parseInt;
function Q(n) {
  if (typeof n == "number")
    return n;
  if (x(n))
  ...
  n = G(n);
  var t = K.test(n);
  return t || z.test(n) ? C(n.slice(2), t ? 2 : 8) : H.test(n) ? o : +n;
}
