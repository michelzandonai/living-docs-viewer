import { G as g } from "./graph-kIpOKHqm.js";
import { b as Te, p as ce, q as le, g as X, e as ee, l as F, o as Me, s as Ie, c as Se, u as je, d as f, i as m, f as _, v as x, r as I } from "./_baseUniq-BMAn-U5W.js";
import { f as O, b as he, a as Fe, c as Ve, d as Ae, t as V, m as w, e as P, h as ve, g as z, l as T, i as Be } from "./_basePickBy-C3AhkYYV.js";
import { aW as Ge, aX as Ye, aY as De, aM as qe, aZ as $e, aQ as pe, aP as we, a_ as We, aL as q, aq as Xe, aS as ze, as as Ue, a$ as $ } from "./mermaid.core-r1-Nq2X6.js";
function He(e) {
...
function Ir(e, n) {
  n("    makeSpaceForEdgeLabels", () => $r(e)), n("    removeSelfEdges", () => Kr(e)), n("    acyclic", () => kn(e)), n("    nestingGraph.run", () => Hn(e)), n("    rank", () => Xn(be(e))), n("    injectEdgeLabelProxies", () => Wr(e)), n("    removeEmptyRanks", () => Nn(e)), n("    nestingGraph.cleanup", () => Qn(e)), n("    normalizeRanks", () => Ln(e)), n("    assignRankMinMax", () => Xr(e)), n("    removeEdgeLabelProxies", () => zr(e)), n("    normalize.run", () => Sn(e)), n("    parentDummyChains", () => pr(e)), n("    addBorderSegments", () => _n(e)), n("    order", () => hr(e)), n("    insertSelfEdges", () => et(e)), n("    adjustCoordinateSystem", () => Rn(e)), n("    position", () => Tr(e)), n("    positionSelfEdges", () => nt(e)), n("    removeBorderNodes", () => Qr(e)), n("    normalize.undo", () => Fn(e)), n("    fixupEdgeLabelCoords", () => Zr(e)), n("    undoCoordinateSystem", () => Tn(e)), n("    translateGraph", () => Ur(e)), n("    assignNodeIntersects", () => Hr(e)), n("    reversePoints", () => Jr(e)), n("    acyclic.undo", () => En(e));
}
function Sr(e, n) {
  f(e.nodes(), function(r) {
