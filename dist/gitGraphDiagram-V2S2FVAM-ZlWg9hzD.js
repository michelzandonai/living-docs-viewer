import { p as Z } from "./chunk-4BX2VUAB-BesGezha.js";
import { I as F } from "./chunk-QZHKN3VN-K7z0W47M.js";
import { p as U, o as rr, s as er, g as tr, a as ar, b as nr, _ as h, l as m, u as sr, B as or, x as cr, j as B, C as ir, D as dr, E as hr, c as lr, F as $r } from "./mermaid.core-CoRdmO9j.js";
import { p as fr } from "./mermaid-parser.core-BO3RZIfK.js";
import { s as gr } from "./index-BJzl1930.js";
var u = {
  NORMAL: 0,
  REVERSE: 1,
  HIGHLIGHT: 2,
  MERGE: 3,
  CHERRY_PICK: 4
}, yr = dr.gitGraph, z = /* @__PURE__ */ h(() => ir({
  ...yr,
  ...hr().gitGraph
}), "getConfig"), i = new F(() => {
...
}, S = lr(), b = S == null ? void 0 : S.gitGraph, R = 10, I = 40, k = 4, L = 2, O = 8, C = /* @__PURE__ */ new Map(), E = /* @__PURE__ */ new Map(), P = 30, G = /* @__PURE__ */ new Map(), W = [], M = 0, x = "LR", jr = /* @__PURE__ */ h(() => {
...
`, "id:", r, a), !b)
  ...
  }), K(o, G, !1), b.showBranches && ee(o, c), re(o, G), K(o, G, !0), sr.insertTitle(
    o,
    "gitTitleText",
    b.titleTopMargin ?? 0,
    n.getDiagramTitle()
